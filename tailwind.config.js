...
export default {
  ...
  theme: {
    extend: {
      ...
      // ── 컬러 v3 (딥 틸그린 · 라이트 단일, 다크 없음) ───────────
      colors: {
        // Primary — 딥·저채도·블루끼 틸그린 (행사 공식 그린 파생)
        primary: {
          50: '#eff5f4', 100: '#d5e7e5', 200: '#aed0cc', 300: '#7fb1ab', 400: '#548f88',
          500: '#37766f', 600: '#2c605a', 700: '#234d49', 800: '#1b3b38', 900: '#152e2b',
        },
