...
export default function Identify({ onLogin }: { onLogin: (s: FieldSession) => void }) {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* 헤더 */}
      <header className="bg-primary-700 px-6 pb-6 pt-10 text-white">
        <div className="font-latin text-[11px] font-semibold uppercase tracking-[0.2em] text-primary-200/70">
          ITS World Congress 2026
        </div>
        <div className="mt-1.5 font-title text-title font-medium leading-tight">부대행사 현장앱</div>
        <div className="mt-1 text-label text-primary-200/80">자원봉사자 · 거점관리자 신원확인</div>
      </header>
